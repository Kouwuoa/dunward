//! Builder pattern for Vulkan descriptor set layouts.
//!
//! Simplifies configuring [`ash::vk::DescriptorSetLayoutBinding`] arrays, binding flags
//! (including bindless / update-after-bind), and immutable samplers.
